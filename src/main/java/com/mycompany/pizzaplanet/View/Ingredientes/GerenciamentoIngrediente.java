...
public class GerenciamentoIngrediente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CBtxtCategoria = new javax.swing.JComboBox<>();
        ...
        CBtxtCategoria.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        CBtxtCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Doce", "Salgado" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(CBtxtCategoria, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(CBtxtCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if(ListIngrediente.getSelectedValue() != null) {
            for(Ingrediente ingre : Ingrediente.getlistaIngrediente()) {
                if(ingre.getNome().equals(ListIngrediente.getSelectedValue().toString())) {
                    ...
                    CBtxtCategoria.setSelectedItem(ingre.getCategoria());
    ...
    private void btnEditIngreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditIngreActionPerformed
        ...
        try {
            ...
            Ingrediente ingreNovo = new Ingrediente(txtIngrediente.getText().trim(), CBtxtCategoria.getSelectedItem().toString());
    ...
    private javax.swing.JComboBox<String> CBtxtCategoria;
